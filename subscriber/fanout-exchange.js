...
console.log({queue,exchangeName});
...
async function subscriber () {
    ...
    // ↑ es importante unir los bindQueue a los exchanges antes de empezar a publicar, porque si no voy a perder mensajes que se enviaron, pero nunca llegaron.
